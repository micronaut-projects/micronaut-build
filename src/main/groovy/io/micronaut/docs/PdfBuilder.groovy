...
class PdfBuilder {
    ...
    static boolean cleanHtml = System.getProperty('io.micronaut.docss.clean.html') == null ? true : Boolean.getBoolean("io.micronaut.docss.clean.html")
    static boolean debugPdf = Boolean.getBoolean("io.micronaut.docss.debug.pdf")
